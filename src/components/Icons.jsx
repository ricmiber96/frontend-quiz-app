...
export function CorrectIcon ({ width = 60, height = 60 }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' className='icon icon-tabler icon-tabler-circle-check' width={width} height={height} viewBox='0 0 24 24' strokeWidth='2' stroke='#2dcc0c' fill='none' strokeLinecap='round' strokeLinejoin='round'><path stroke='none' d='M0 0h24v24H0z' fill='none'/><path d='M12 12m-9 0a9 9 0 1 0 18 0a9 9 0 1 0 -18 0' /><path d='M9 12l2 2l4 -4' /></svg>
  )
}

export function ErrorIcon ({ width = 60, height = 60 }) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' className='icon icon-tabler icon-tabler-square-rounded-x' width={width} height={height} viewBox='0 0 24 24' strokeWidth='2' stroke='#FF0000' fill='none' strokeLinecap='round' strokeLinejoin='round'>
      <path stroke='none' d='M0 0h24v24H0z' fill='none'></path>
